...
data type ShapeTypeExtended from example.idl.
...
Make sure that java and javac are in your path before you start. From your
command shell, type:
> make -f makefile_example_x64Darwin17clang9.0 ShapeTypeExtendedPublisher
> make -f makefile_example_x64Darwin17clang9.0 ShapeTypeExtendedSubscriber
