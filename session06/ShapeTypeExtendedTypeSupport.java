...
public class ShapeTypeExtendedTypeSupport extends TypeSupportImpl {
    ...
    private static final String TYPE_NAME = "ShapeTypeExtended";
    ...
    */
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            if (typedSrc.angle < -3.4E38 
            || typedSrc.angle >3.4E38){
                throw new RETCODE_ERROR("ShapeTypeExtended::angle serialization error. Primitive value "+ typedSrc.angle
                + " outside valid range [-3.4E38, 3.4E38]"  );
            }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            try{
                ...
                if (typedDst.angle < -3.4E38 
                || typedDst.angle >3.4E38){
                    throw new RETCODE_ERROR("ShapeTypeExtended::angle deserialization error. Primitive value "+ typedDst.angle
                    + " outside valid range [-3.4E38, 3.4E38]"  );
                }
