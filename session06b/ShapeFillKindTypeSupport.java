...
public class ShapeFillKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "ShapeFillKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ShapeFillKindTypeSupport _singleton
    = new ShapeFillKindTypeSupport();
    ...
    */
    public static ShapeFillKindTypeSupport get_instance() {
        return _singleton;
    }

    public static ShapeFillKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ShapeFillKindTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>ShapeFillKind</code>
    * type.
    */
    @Override 
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
        ShapeFillKind typedSrc = (ShapeFillKind) src;
    ...
    protected ShapeFillKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, ShapeFillKindTypeCode.VALUE, ShapeFillKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
