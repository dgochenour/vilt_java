...
/**
* A sequence of ShapeFillKind instances.
*/
public final class ShapeFillKindSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ShapeFillKindSeq() {
        super(ShapeFillKind.class);
    }

    public ShapeFillKindSeq (int initialMaximum) {
        super(ShapeFillKind.class, initialMaximum);
    }

    public ShapeFillKindSeq (Collection<?> elements) {
        super(ShapeFillKind.class, elements);
    }

    public  ShapeFillKind get(int index) { 
        return (ShapeFillKind) super.get(index); 
    }
